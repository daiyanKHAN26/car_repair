...
<form method="post" action="add.php" class="add">
	...
	<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
		...
		<label style="font-weight: bold;">userID</label>
	   	<input type="text" name="usersearch" class="xd">
	...
	$usersearch = mysqli_real_escape_string($mysqli,$_POST['usersearch']);
...
if(count($errors)==0){
	...
	$sql7 = "INSERT INTO  description (descID,descName,treatment,note,mechanicIDdesc) VALUES ('$descID','$descName','$treatment','$note','$mechanicprofile') ";
